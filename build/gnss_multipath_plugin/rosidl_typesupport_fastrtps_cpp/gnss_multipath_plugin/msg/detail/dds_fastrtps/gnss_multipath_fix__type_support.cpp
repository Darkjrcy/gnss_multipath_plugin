...
#include "gnss_multipath_plugin/msg/detail/gnss_multipath_fix__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const gnss_multipath_plugin::msg::GNSSMultipathFix *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gnss_multipath_plugin::msg::GNSSMultipathFix *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GNSSMultipathFix__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gnss_multipath_plugin::msg::GNSSMultipathFix *>(
...
{
  return max_serialized_size_GNSSMultipathFix(full_bounded, 0);
}

static message_type_support_callbacks_t _GNSSMultipathFix__callbacks = {
...
static rosidl_message_type_support_t _GNSSMultipathFix__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GNSSMultipathFix__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_gnss_multipath_plugin
const rosidl_message_type_support_t *
get_message_type_support_handle<gnss_multipath_plugin::msg::GNSSMultipathFix>()
{
  return &gnss_multipath_plugin::msg::typesupport_fastrtps_cpp::_GNSSMultipathFix__handle;
}
